...
namespace Servicio
{
    public class cCiclo
    {
        ...
        {
            string ciclo = null;
            List<Ciclos> lista = obtenerPorNombre(horno, noCiclo);
            try
            {
                foreach (var item in lista)
                {
                    ciclo = item.Horno + " " + item.No_Ciclo + " " + item.Fecha + " " + item.Hora + " " + item.PK_Usuario;
                }
            }
            catch (Exception)
            {
        ...
        {
            foreach (Ciclos ciclo in obtenerPorHorno(horno))
            {
        ...
        /// </summary>
        /// <returns></returns>
        public List<Ciclos> obtenerTodos()
        {
            List<Ciclos> lista = null;
            try
            {
                lista = new List<Ciclos>();
                using (var entidad = new MuestrasHornosEntities())
                {
                    var consulta = from c in entidad.Ciclos
                                   select c;
        ...
        /// </summary>
        /// <returns></returns>
        public List<Ciclos> obtenerPorHorno(string horno)
        {
            List<Ciclos> lista = null;
            try
            {
        ...
        /// <param name="nombreCiclo"></param>
        /// <returns></returns>
        public List<Ciclos> obtenerPorNombre(string horno, int noCiclo)
        {
            string Horno = horno;
            int ciclo = noCiclo;
            List<Ciclos> lista = null;
        ...
        public Ciclos obtenerCiclo(string horno, int noCiclo)
        {
            string Horno = horno;
            int ciclo = noCiclo;
            Ciclos ciclos = null;
